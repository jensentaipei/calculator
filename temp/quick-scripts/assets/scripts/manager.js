...
cc._RF.push(module, 'd06f3rCbY1OhagHGu4lWPDO', 'manager', __filename);
// scripts/manager.js
...
cc.Class({
    ...
    //#region EnterNumber
    number: function number(event, customEventData) {
    ...
    addfun: function addfun() {
        ...
        this.scoreDisplay.string = this.score;
        if (this.score === Number.POSITIVE_INFINITY || this.score === -Number.POSITIVE_INFINITY || isNaN(this.score)) {
